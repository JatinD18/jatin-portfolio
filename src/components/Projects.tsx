      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <motion.div
            ...
            whileHover={{ y: -10 }}
            className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden hover:border-blue-500/50 transition duration-300 group"
          >
              ...
              <div className="absolute inset-0 bg-blue-900/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                {project.liveLink !== "#" && (
                  <motion.a
                    ...
                    className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-blue-900"
                  >
            ...
            <div className="p-6 flex flex-col flex-1">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tech.map((t) => (
                  <span
                    key={t}
                    className="text-xs bg-gray-800 text-blue-300 px-2.5 py-1 rounded-full hover:bg-blue-500 hover:text-white transition-colors cursor-default"
                  >
                    {t}
                  </span>
                ))}
